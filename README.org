...
- [[#listen-music-info][listen-music-info]]
...
* listen-music-info
#+begin_src shell :tangle listen-music-info.sh
...
* update-music
#+begin_src shell :tangle update-music.sh
# if [[ $(eww ping 2> /dev/null) == "pong" ]]; then
#     ~/.config/eww/scripts/update-music.sh
# fi
#+end_src
