...
- [[#idea-get-acoustid][IDEA get-acoustid]]
...
This needs to be clear it can only target a file rather than showing the id of
currently playing track like ~get-music~ script does.

#+begin_src shell :tangle get-acoustid.sh
music_file="$1"
