...
#+begin_src shell
autostart_script="$XDG_CONFIG_HOME/autostart-scripts/autostart.sh"
autostart_script_org="$XDG_CONFIG_HOME/README.org"
#+end_src
...
setRandomWallpaper() {
    for (( i = 0; i < $screens; i++ )); do
        echo nitrogen --set-zoom-fill --random --head=$i $wall_dir/$1/
